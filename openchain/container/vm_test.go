...
func TestVM_BuildImage_ChaincodeCca(t *testing.T) {
	vm, err := NewVM()
	if err != nil {
		t.Fail()
		t.Logf("Error getting VM: %s", err)
	...
	// Build the spec
	chaincodePath := "/opt/gopath/src/github.com/openblockchain/obc-peer/openchain/example/chaincode/cca/com.obc.chaincode.example02-0.1-SNAPSHOT.cca"
